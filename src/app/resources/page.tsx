...
export default function TreeValueResources() {
  return (
    <div className="min-h-screen">
      ...
      {/* Species Calculators - Compact */}
      <section className="py-12 bg-forest-50 border-t border-forest-100">
        <div className="max-w-6xl mx-auto px-6">
          <h3 className="font-heading text-lg font-semibold text-charcoal-900 mb-4 text-center">
            Species-Specific Calculators
          </h3>
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/oak-tree-value-calculator" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Oak</Link>
            <Link href="/maple-tree-value-calculator" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Maple</Link>
            <Link href="/live-oak-tree-value-calculator" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Live Oak</Link>
            <Link href="/pecan-tree-value-calculator" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Pecan</Link>
            <Link href="/black-walnut-tree-value-calculator" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Black Walnut</Link>
            <Link href="/cedar-tree-value-calculator" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Cedar</Link>
            <Link href="/cypress-tree-value-calculator" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Cypress</Link>
            <Link href="/fruit-tree-value-calculator" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Fruit Trees</Link>
            <Link href="/best-tree-value-calculator-apps" className="px-4 py-2 bg-white rounded-lg border border-charcoal-200 text-sm text-charcoal-700 hover:border-forest-400 hover:text-forest-700 transition-colors">Compare Tools</Link>
          </div>
        </div>
      </section>
